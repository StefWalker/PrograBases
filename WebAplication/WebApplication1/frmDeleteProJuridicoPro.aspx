<%@ Page Title="" Language="C#" MasterPageFile="~/Anonimo.Master" AutoEventWireup="true" CodeBehind="frmDeleteProJuridicoPro.aspx.cs" Inherits="WebApplication1.frmDeleteProJuridicoPro" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="abrigo_formulario"> 
      <h2>Eliminar unión entre un propietario juridico y una propiedad</h2>
        <br />
        <table>
            <tr>
