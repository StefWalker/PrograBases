<%@ Page Title="" Language="C#" MasterPageFile="~/Anonimo.Master" AutoEventWireup="true" CodeBehind="frmAgregarPropiedad.aspx.cs" Inherits="WebApplication1.frmAgregarPropiedad" %>
      ...
      <h2>Nueva Propiedad</h2>
        ...
        <table>
            <tr>
                ...
                <td> <asp:TextBox ID="IdPropietario" runat="server" width="200px"></asp:TextBox></td>
            </tr>
            <tr>
