...
{
    public partial class frmRealizarPagos : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("frmPendientes.aspx?ID_Propiedad=" + grvPropiedades.Rows[grvPropiedades.SelectedIndex].Cells[0].Text);
        }
    }
}